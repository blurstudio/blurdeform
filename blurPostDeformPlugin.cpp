...
// that blurSculpts vertices according to their CV's weights. The weights are
// set using the set editor or the percent command.
//
// To use this node:
...
//	  to control the direction of the blurSculpt. The object's CV's will be
//blurSculpt 	  by the value of the weights of the CV's (the default will be the
//weight * some constant) 	  in the direction of the y-vector of the locator
